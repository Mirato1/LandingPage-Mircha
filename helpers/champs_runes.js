...
const champions = [
	{
		...
		items: ['Goredrinker.png', 'Sterakk.png', 'DD.png', 'GA.png', 'Chemptank.png', 'Tabis.png'],
		priority: [
			{
				orden: ['Q', 'E', 'W'],
		...
		counters: [
			...
			},
			{
				nombre: 'Tryndamere',
				tips: `
            <li>Guardarse la <b>E</b> porque si se tira nos caga a piñas.</li>
            `,
			},
			{
				nombre: 'Jayce',
		...
		easy: [
            ...
            <li>Si es <b>Hachi</b> no necesitas consejos ya que es free lp.</li>
            `,
			},
			{
				nombre: 'Gnar',
	...
	},
	{
		...
		items: ['Kraken.png', 'Collector.png', 'Infinity.png', 'Dominik.png', 'GA.png', 'Berseker.png'],
		priority: [
			{
				orden: ['E', 'Q', 'W'],
	...
	},
	{
		...
		items: ['Everfrost.png', 'Cosmic.png', 'Zhonyas.png', 'Deathcap.png', 'Morello.png', 'Ionia.png'],
		priority: [
			{
				orden: ['W', 'Q', 'E'],
	...
	},
	{
		...
		items: ['Goredrinker.png', 'Black.png', 'Sterakk.png', 'DD.png', 'GA.png', 'Tabis.png'],
		priority: [
			{
				orden: ['Q', 'E', 'W'],
	...
	},
	{
		...
		items: ['Goredrinker.png', 'Sterakk.png', 'Hydra.png', 'DD.png', 'GA.png', 'Tabis.png'],
		priority: [
			{
				orden: ['Q', 'W', 'E'],
	...
	},
	{
		...
		items: ['Sunderer.png', 'Sterakk.png', 'Hydra.png', 'DD.png', 'GA.png', 'Tabis.png'],
		priority: [
			{
				orden: ['Q', 'E', 'W'],
	...
	},
	{
		...
		items: ['Protobelt.png', 'Zhonyas.png', 'Deathcap.png', 'VoidStaff.png', 'Morello.png', 'Sorcerer.png'],
		priority: [
			{
				orden: ['Q', 'E', 'W'],
	...
	},
	{
		...
		items: ['Goredrinker.png', 'Sterakk.png', 'Reaver.png', 'DD.png', 'GA.png', 'Tabis.png'],
		priority: [
			{
				orden: ['Q', 'E', 'W'],
	...
	},
	{
		...
		items: ['Riftmaker.png', 'Cosmic.png', 'Zhonyas.png', 'Nashor.png', 'Morello.png', 'Ionia.png'],
		priority: [
			{
				orden: ['Q', 'E', 'W'],
	...
	},
	{
		...
		items: ['Eclipse.png', 'Muramana.png', 'Serpent.png', 'Serylda.png', 'GA.png', 'Ionia.png'],
		priority: [
			{
				orden: ['Q', 'E', 'W'],
				skill: ['JayceToTheSkies.png', 'JayceThunderingBlow.png', 'JayceStaticField.png'],
			},
		],
		arbol: ['Precision', 'Inspiration'],
		mastery: [4, 3, 1, 3, 2, 3, 0, 1, 1, 2],
		order: [[1, 3, 5, 7, 9, 11], [4, 6, 8, 10, 12, 13], [2, 14, 15, 16, 17, 18], []],
		rol: fighter,
		tips: `
        <li>
            En <b>early</b> abusar mucho del rango y el daño que hace nuestra pasiva + la runa.
	...
	},
	{
		...
		items: ['Protobelt.png', 'Cosmic.png', 'Deathcap.png', 'Zhonyas.png', 'VoidStaff.png', 'Sorcerer.png'],
		priority: [
			{
				orden: ['Q', 'E', 'W'],
	...
	},
	{
		...
		items: ['ShieldBow.png', 'Reaver.png', 'Collector.png', 'Infinity.png', 'Dominik.png', 'Ionia.png'],
		priority: [
			{
				orden: ['Q', 'E', 'W'],
	...
	},
	{
		...
		items: ['Goredrinker.png', 'Ruined.png', 'Sterakk.png', 'Titanic.png', 'DD.png', 'Tabis.png'],
		priority: [
			{
				orden: ['Q', 'W', 'E'],
	...
	},
	{
		...
		items: ['Protobelt.png', 'Zhonyas.png', 'Cosmic.png', 'Morello.png', 'Deathcap.png', 'Sorcerer.png'],
		priority: [
			{
				orden: ['Q', 'W', 'E'],
				skill: ['KennenShurikenHurlMissile1.png', 'KennenBringTheLight.png', 'KennenLightningRush.png'],
			},
		],
	...
	},
	{
		...
		items: ['Sunderer.png', 'Black.png', 'Sterakk.png', 'WitEnds.png', 'DD.png', 'Tabis.png'],
		priority: [
			{
				orden: ['Q', 'E', 'W'],
