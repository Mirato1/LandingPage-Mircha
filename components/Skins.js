export function skins(campeon) {
	...
	async function sliders() {
		try {
			...
			const champsAPI = 'https://ddragon.leagueoflegends.com/cdn/11.18.1/data/en_US/champion/',
				splashAPI = 'https://ddragon.leagueoflegends.com/cdn/img/champion/splash/';
			...
			for (const key of numNombre) {
				while ($splashSection.firstElementChild.classList.contains('carrousel__slide')) {
